...
namespace Sqrat
{
    ...
    public:
        ...
        R Evaluate()
        {
            sq->pushobject(vm, obj);
            sq->pushobject(vm, env);

            SQRESULT result = sq->call(vm, 1, true, ErrorHandling::IsEnabled());
            if (SQ_FAILED(result))
            {
                sq->pop(vm, 1);
        ...
        R Evaluate(A1 a1)
        {
            ...
            sq->call(vm, 2, true, ErrorHandling::IsEnabled());
            Var<R> ret(vm, -1);
            sq->pop(vm, 2);
            return ret.value;
        }
        ...
        R Evaluate(A1 a1, A2 a2)
        {
            ...
            sq->call(vm, 3, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3)
        {
            ...
            sq->call(vm, 4, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3, A4 a4)
        {
            ...
            sq->call(vm, 5, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5)
        {
            ...
            sq->call(vm, 6, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6)
        {
            ...
            sq->call(vm, 7, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7)
        {
            ...
            sq->call(vm, 8, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8)
        {
            ...
            sq->call(vm, 9, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9)
        {
            ...
            sq->call(vm, 10, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10)
        {
            ...
            sq->call(vm, 11, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10, A11 a11)
        {
            ...
            sq->call(vm, 12, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10, A11 a11, A12 a12)
        {
            ...
            sq->call(vm, 13, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10, A11 a11, A12 a12, A13 a13)
        {
            ...
            sq->call(vm, 14, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        R Evaluate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10, A11 a11, A12 a12, A13 a13, A14 a14)
        {
            ...
            sq->call(vm, 15, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).value;
            sq->pop(vm, 2);
            return ret;
        }
        ...
        void Execute()
        {
            ...
            SQRESULT result = sq->call(vm, 1, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        ...
        void Execute(A1 a1)
        {
            ...
            sq->call(vm, 2, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2)
        {
            ...
            sq->call(vm, 3, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3)
        {
            ...
            sq->call(vm, 4, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3, A4 a4)
        {
            ...
            sq->call(vm, 5, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5)
        {
            ...
            sq->call(vm, 6, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6)
        {
            ...
            sq->call(vm, 7, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7)
        {
            ...
            sq->call(vm, 8, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8)
        {
            ...
            sq->call(vm, 9, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9)
        {
            ...
            sq->call(vm, 10, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10)
        {
            ...
            sq->call(vm, 11, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10, A11 a11)
        {
            ...
            sq->call(vm, 12, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10, A11 a11, A12 a12)
        {
            ...
            sq->call(vm, 13, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10, A11 a11, A12 a12, A13 a13)
        {
            ...
            sq->call(vm, 14, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
        ...
        void Execute(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10, A11 a11, A12 a12, A13 a13, A14 a14)
        {
            ...
            sq->call(vm, 15, false, ErrorHandling::IsEnabled());
            sq->pop(vm, 1);
        }
